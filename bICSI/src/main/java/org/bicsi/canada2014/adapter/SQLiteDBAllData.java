	...
	public Cursor fetchScheduleByDate(String inputText, String newConfDate) throws SQLException {
	   ...
	   if (inputText == null  ||  inputText.length () == 0)  {
	    mCursor = db.query(SQLITE_TABLE, new String[] {
	    		...
	    		KEY_fucntioindate + " = " + newConfDate + " AND (" + KEY_ID + " LIKE 'ATT%' OR " + KEY_ID + " LIKE 'BIC%' OR " + KEY_ID + " LIKE 'BREA%' OR " + KEY_ID + " LIKE 'COM%' OR " + KEY_ID + " LIKE 'CONC%' OR " + KEY_ID + " LIKE 'CONF%' OR " + KEY_ID + " LIKE 'CRED_E%' OR " + KEY_ID + " LIKE 'EH%' OR " + KEY_ID + " LIKE 'GS_TUE_%' OR " + KEY_ID + " LIKE 'GS_THU_%' OR " + KEY_ID + " LIKE 'GS_WED_%' OR " + KEY_ID + " LIKE 'EX_REG%' OR " + KEY_ID + " LIKE 'EXAM_CHECK' OR " + KEY_ID + " LIKE 'CSC_%' OR " + KEY_ID + " LIKE 'EXV_REG%' OR " + KEY_ID + " LIKE 'BANQ_COMP' OR " + KEY_ID + " LIKE 'BANQ_RECEP' OR " + KEY_ID + " LIKE 'PRECON%') ORDER BY " + KEY_functionStartTime + ", " + KEY_functionEndTime + " ASC", null, null, null, null, null);
